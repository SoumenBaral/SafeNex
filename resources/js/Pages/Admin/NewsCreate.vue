    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ reportData ? 'Create Article from Report' : 'Create Article' }}
            </h2>
        </template>
            ...
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        <div v-if="reportData" class="rounded-md bg-blue-50 p-3 text-sm text-blue-700">
                            Pre-filled from verified report #{{ reportData.report_id }}
                        </div>
                        ...
                        <div>
                            ...
                            <p v-if="form.existing_cover" class="mt-1 text-xs text-gray-400">Using image from report (will be replaced if you upload a new one)</p>
                        </div>
